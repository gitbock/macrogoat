...
namespace MacroGoat
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, DataContext db, GHelperService helper, UserManager<GUser> userManager, RoleManager<IdentityRole> roleManager)
        {
